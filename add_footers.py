...
footer = """<!-- DETAILED CORPORATE FOOTER -->
            ...
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-slate-800 pb-16">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-slate-400 text-sm">
                            <li><a href="form_life_insurance.html" class="hover:text-pink-400 transition">Life Insurance & Family Protection</a></li>
                            <li><a href="form_regular_income.html" class="hover:text-pink-400 transition">Regular Income Planning</a></li>
                            <li><a href="form_child_future.html" class="hover:text-pink-400 transition">Child Future Planning</a></li>
                            <li><a href="form_health_insurance.html" class="hover:text-pink-400 transition">Health Insurance Planning</a></li>
                            <li><a href="form_motor_insurance.html" class="hover:text-pink-400 transition">Motor Insurance Strategy</a></li>
                        </ul>
                    </div>
                    <div>
...
for f in glob.glob('form_*.html') + ['contact.html']:
    with open(f, 'r', encoding='utf-8') as file:
        content = file.read()
    
    if '<!-- DETAILED CORPORATE FOOTER -->' not in content:
